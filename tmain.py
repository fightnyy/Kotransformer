...
def train_model(rank, world_size, args):
    ...
    model = movieclassifier.MovieClassification(config)
    ...
    train_loader, train_sampler = build_data_loader(vocab, config.train_data, args, shuffle=True)
    test_loader, _ = build_data_loader(vocab, config.test_data, args, shuffle=False)
